...
class AvailabilityCheckerTest < ActiveSupport::TestCase
  ...
  setup do
    ...
    @user = User.create!(name: "参加 太郎", email: "ivr@example.com", password: "password1234", participant: true)
  end
  ...
  test "16. 2名選択時、片方だけ埋まっている区間は all_available? が false" do
    busy = User.create!(name: "予定 花子", email: "busy@example.com", password: "password1234", participant: true)
